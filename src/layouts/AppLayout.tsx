      ...
      <div className="workspace">
        <header className="topbar">
          ...
          <div className="topbar-stats">
            <span className="stat stat-flame" title="Dias seguidos estudando"><Icon name="flame" size={20} />0 <small>dias</small></span>
            <span className="stat stat-star" title="Pontos de experiência"><Icon name="star" size={20} />0 <small>XP</small></span>
